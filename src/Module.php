 ...
 * ]
 * ```
 * @author igorkri Visweswaran <igorkriv2@gmail.com>
 * @since  1.0
 */
class Module extends \igorkri\base\Module
{
    /**
    ...
    /**
     * @var string the name to identify the nested set behavior name in the [[\igorkri\tree\models\Tree]] model.
     */
